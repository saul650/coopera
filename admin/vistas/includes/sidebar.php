...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="myprofile.php"><i class="material-icons">account_box</i>Mis perfiles</a></li>
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Cambia la contraseña</a></li>
                    <li class="no-padding">
                ...
                <div class="footer">
                    <p class="copyright">tusolutionweb<a href="http://www.tusolutionweb.org/">,mas codigo gratis </a>©</p>
