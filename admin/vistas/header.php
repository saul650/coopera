...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="../public/img/logoo.png">
...
?>
      ...
      <span class="logo-lg"><b>CAS</b>-Administrador</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Cooperativa Apostol de Santiago</small>
                </p>
              </li>
              <!-- Menu Footer-->
...
<div class="user-panel">
      ...
      <li class="treeview">
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Creacion de prestamos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="formula_busq.php"><i class="fa fa-circle-o"></i> Creacion de prestamos</a></li>
            <li><a href="reportes.php"><i class="fa fa-circle-o"></i> Reportes</a></li>
            <li><a href="prestamo.php"><i class="fa fa-circle-o"></i> prestamo</a></li>
           
          </ul>
      </li>
      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Licencias</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="licencia.php"><i class="fa fa-circle-o"></i> Licencias</a></li>
...
?>
      ...
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CAS</b>-Empleado</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
